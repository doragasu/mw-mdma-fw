...
#define _DESCRIPTORS_H_
	...
	/* Macros: */
		 ...
		 * \note Although AT90USB646 microcontroller supports up to 256 bytes
		 * length for endpoint 1, it looks like LUFA doesn't allow it. Trying
		 * to configure a 256 byte endpoint causes configuration to fail.
		 */
		// Maximum received/sent data is 32 bytes plus cmd (1), header(1) and addr (4)
//		#define VENDOR_I_EPSIZE               (32 + 6)
//		#define VENDOR_O_EPSIZE               (32 + 6)
		#define VENDOR_I_EPSIZE               64
		#define VENDOR_O_EPSIZE               64
		//#define VENDOR_IO_EPSIZE               (32 + 6)
